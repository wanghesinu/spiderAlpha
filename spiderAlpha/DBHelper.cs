...
namespace spiderAlpha
{
    class DBHelper
    {
        ...
        我这里是构建一个目录：当前目录先的db文件夹下的StuMandata.mdb数据库文件。
当然你可以可以直接指定目录：例：严重性	代码	说明	项目	文件	行
错误		Source file 'C:\Users\weimi\Documents\Visual Studio 2015\Projects\spiderAlpha\spiderAlpha\MainDBDataSet.Designer.cs' could not be found.	spiderAlpha	C:\Users\weimi\Documents\Visual Studio 2015\Projects\spiderAlpha\spiderAlpha\CSC	

string_strdata=@"provider=microsoft.jet.oledb.4.0; Data Source=C:\db\StuManData.mdb";*/
        //public static readonly string conn_str = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Users\\weimi\\Documents\\Visual Studio 2015\\Projects\\littleSpider";
        //public static readonly string connectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Directory.GetCurrentDirectory() + "\\MainDB.mdb;Jet OLEDB:Database Password=hailai2015";
        public static readonly string connectionString = ConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
        //public static readonly string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source =| DataDirectory |\MainDB.mdb;Jet OLEDB:Database Password = hailai2015";
        // public static readonly string conn_str = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\\MainDB.mdb";
